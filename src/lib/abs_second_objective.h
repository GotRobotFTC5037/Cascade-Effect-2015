...
e_scoring_options abs_second_objective(e_scoring_options previously_completed_obj, user_input * usr_input)
{
	...
	else
	{
		...
		case CENTER_GOAL:
			...
			case ROLLGOAL1:
				...
				last_successful_obj = usr_input->second_obj;
				break;
			case ROLLGOAL2:
				switch(g_center_goal_pos)
				{
