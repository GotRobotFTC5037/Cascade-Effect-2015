...
void abs_smoke_test_view(int test_num,int test_value1, int test_value2)
{
	switch(test_num)
	{
	case 1: abs_cscreen("Ball    ","lift    ","%1d       ",test_value1); break;
	...
	case 5: abs_cscreen("N/A     ","        ","%1d       ",test_value1); break;
	case 6: abs_cscreen("N/A     ","        ","%1d       ",test_value1); break;
	case 7: abs_cscreen("N/A     ","        ","%1d       ",test_value1); break;
	case 8: abs_cscreen("N/A     ","        ","%1d       ",test_value1); break;
	case 9: abs_cscreen("N/A     ","        ","%1d       ",test_value1); break;
