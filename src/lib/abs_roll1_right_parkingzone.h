/**
*
*  @file abs_roll1_right_parkingzone.h
*
...
#ifndef ABS_ROLL1_RIGHT_PARKINGZONE_H
#define ABS_ROLL1_RIGHT_PARKINGZONE_H

#include "abs_turn.h"
#include "abs_drive.h"
#include "abs_auto_end.h"

void abs_roll1_right_parkingzone()
{
	...
	abs_drive(FORWARD, E_ANGLE, 450, 100, true, GYRO, DONT_SLOW_DOWN, DO_STALL_ACTION);
...
#endif /* !ABS_ROLL1_RIGHT_PARKINGZONE_H */
